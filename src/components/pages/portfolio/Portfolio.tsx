...
export const Portfolio = () => {
    ...
    return (
        <React.Fragment>
            <Header title="header_portfolio" subtitle="header_portfolio_sub" classColor="bg-indigo-200"></Header>
            <div className=" mx-auto mt-10 box-border box-content w-4/5 mx-auto mt-10">
                {
                    isLoading
                        ? <Loading />
